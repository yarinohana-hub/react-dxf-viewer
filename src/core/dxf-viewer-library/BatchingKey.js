...
export class BatchingKey {
     ...
     */
    constructor(layerName, blockName, geometryType, color, lineType, dxfHandle = null, dxfType = null) {
    ...
    Compare(other) {
        ...
        c = CompareValues(this.dxfHandle, other.dxfHandle)
        if (c !== 0) {
            return c
        }
        return CompareValues(this.dxfType, other.dxfType)
    }
